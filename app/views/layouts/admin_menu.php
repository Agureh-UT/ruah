...
$admin_menu = Router::getMenu('admin_menu_acl');
$userMenu = Router::getMenu('user_menu');
?>
<div class="header">
  <div class="headerTop">
    <div class="toggle-bars" id="navbarToggle">☰</div>
    <div class="logo-section">
      <div class="logo">AGsoft ERP</div>
    </div>
    <div class="org-info">
