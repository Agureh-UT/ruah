...
<script>
  tinymce.init({
   ...
   document_base_url : JS_HOST_WITH_SITE_ROOT,
  });
</script>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('.multi-options-select').select2({
      ajax: {
        url: '<?= SITE_ROOT ?>adminproducts/getOptionsForForm',
        dataType: 'json',
    ...
    <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col-md-12 text-right">
          <a href="<?= SITE_ROOT ?>adminproducts" class="btn btn-large btn-secondary">Cancel</a>
