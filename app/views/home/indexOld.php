...
<script>
    ...
    function updateTransactionsTable(transactions) {
        ...
        transactions.forEach(transaction => {
            ...
            const statusClass = transaction.status.toLowerCase() === 'approved' ? 'status-approved' :
    ...
    function updateProjectsTable(projects) {
        ...
        projects.forEach(project => {
            ...
            const statusClass = project.status.toLowerCase() === 'active' ? 'status-approved' :
                project.status.toLowerCase() === 'planning' ? 'status-pending' :
                'status-rejected';
