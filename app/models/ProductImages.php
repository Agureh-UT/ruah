...
class ProductImages extends Model{
  ...
  public static function deleteImages($product_id,$unlink = false){
    ...
    if($unlink){
      $dirname = FILES_ROOT.DS.'uploads' . DS . 'product_images' . DS . 'product_' . $product_id;
  ...
  public static function deleteById($id){
    ...
    if($image){
      ...
      unlink(FILES_ROOT.DS.'uploads'.DS. 'product_images'.DS.'product_'.$image->product_id.DS. $image->name);
