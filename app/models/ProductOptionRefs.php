...
class ProductOptionRefs extends Model{
  ...
  public static function findOrCreate($product_id,$option_id){
    $ref = self::findByUniqueFields($product_id,$option_id);
    if(!$ref){
      $ref = new self();
  ...
  public static function findByUniqueFields($product_id,$option_id){
  ...
  public static function findByProductIdOnly($product_id)
  {
      return self::find([
